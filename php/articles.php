...
?>
  ...
  <main class="flex-1 max-w-[900px] mx-auto w-full feed-border min-h-screen">
    ...
    <div class="p-4 flex flex-col gap-3">
      ...
      ?>
        <a href="/edit_article.php?id=<?= h($article['id']) ?>" class="card p-4 flex items-center justify-between gap-3 hover:bg-surface-3 transition-colors">
          <div class="min-w-0">
          ...
          <span class="material-symbols-outlined text-muted-2">chevron_right</span>
        </a>
      <?php endforeach; ?>
    </div>
  </main>
